...
abstract class AppLocalizations {
  ...
  /// No description provided for @heroArtStyleGhibli.
  ///
  /// In en, this message translates to:
  /// **'Ghibli'**
  String get heroArtStyleGhibli;

  /// No description provided for @heroArtStyleAnime.
  ///
  /// In en, this message translates to:
  /// **'Anime'**
  String get heroArtStyleAnime;

  /// No description provided for @heroArtStyleComic.
  ///
  /// In en, this message translates to:
  /// **'Comic'**
  String get heroArtStyleComic;
  ...
  /// Theme name for everyday/home stories
  ///
  /// In en, this message translates to:
  /// **'Cosy Tale'**
  String get themeCosyHome;

  /// No description provided for @locCosyHomeBedroom.
  ///
  /// In en, this message translates to:
  /// **'Bedroom'**
  String get locCosyHomeBedroom;

  /// No description provided for @locCosyHomeKitchen.
  ///
  /// In en, this message translates to:
  /// **'Kitchen'**
  String get locCosyHomeKitchen;

  /// No description provided for @locCosyHomeGarden.
  ///
  /// In en, this message translates to:
  /// **'Garden'**
  String get locCosyHomeGarden;

  /// No description provided for @locCosyHomeAttic.
  ///
  /// In en, this message translates to:
  /// **'Attic'**
  String get locCosyHomeAttic;

  /// No description provided for @locCosyHomeLivingRoom.
  ///
  /// In en, this message translates to:
  /// **'Living Room'**
  String get locCosyHomeLivingRoom;

  /// No description provided for @locCosyParkNearby.
  ///
  /// In en, this message translates to:
  /// **'Nearby Park'**
  String get locCosyParkNearby;

  /// No description provided for @locCosyLibrary.
  ///
  /// In en, this message translates to:
  /// **'Library'**
  String get locCosyLibrary;

  /// No description provided for @locCosyPlayground.
  ///
  /// In en, this message translates to:
  /// **'Playground'**
  String get locCosyPlayground;

  /// No description provided for @locCosyFarmersMarket.
  ///
  /// In en, this message translates to:
  /// **'Market'**
  String get locCosyFarmersMarket;

  /// No description provided for @locCosyForestClearing.
  ///
  /// In en, this message translates to:
  /// **'Forest Clearing'**
  String get locCosyForestClearing;

  /// No description provided for @locCosyPond.
  ///
  /// In en, this message translates to:
  /// **'Duck Pond'**
  String get locCosyPond;

  /// No description provided for @locCosyMeadow.
  ///
  /// In en, this message translates to:
  /// **'Meadow'**
  String get locCosyMeadow;

  /// No description provided for @goalCosyLostToy.
  ///
  /// In en, this message translates to:
  /// **'Find a Lost Toy'**
  String get goalCosyLostToy;

  /// No description provided for @goalCosyFirstFriend.
  ///
  /// In en, this message translates to:
  /// **'Make a New Friend'**
  String get goalCosyFirstFriend;

  /// No description provided for @goalCosyHelpNeighbour.
  ///
  /// In en, this message translates to:
  /// **'Help a Neighbour'**
  String get goalCosyHelpNeighbour;

  /// No description provided for @goalCosyTidyRoom.
  ///
  /// In en, this message translates to:
  /// **'Tidy the Room'**
  String get goalCosyTidyRoom;

  /// No description provided for @goalCosyBakeTogether.
  ///
  /// In en, this message translates to:
  /// **'Bake Together'**
  String get goalCosyBakeTogether;

  /// No description provided for @goalCosyFeedBirds.
  ///
  /// In en, this message translates to:
  /// **'Feed the Birds'**
  String get goalCosyFeedBirds;

  /// No description provided for @goalCosyBedtimeFear.
  ///
  /// In en, this message translates to:
  /// **'Brave the Dark'**
  String get goalCosyBedtimeFear;

  /// No description provided for @goalCosyShareToy.
  ///
  /// In en, this message translates to:
  /// **'Share a Toy'**
  String get goalCosyShareToy;

  /// No description provided for @goalCosyPlantSeed.
  ///
  /// In en, this message translates to:
  /// **'Plant a Seed'**
  String get goalCosyPlantSeed;

  /// No description provided for @goalCosyRainyAfternoon.
  ///
  /// In en, this message translates to:
  /// **'Rainy Afternoon'**
  String get goalCosyRainyAfternoon;

  /// No description provided for @goalCosyVisitGrandparent.
  ///
  /// In en, this message translates to:
  /// **'Visit Grandparents'**
  String get goalCosyVisitGrandparent;

  /// No description provided for @goalCosyFindPebble.
  ///
  /// In en, this message translates to:
  /// **'Find a Special Pebble'**
  String get goalCosyFindPebble;

  /// No description provided for @locAstronautRingsOfSaturn.
  ///
  /// In en, this message translates to:
  /// **'Rings of Saturn'**
  String get locAstronautRingsOfSaturn;

  /// No description provided for @locAstronautJupiterStorm.
  ///
  /// In en, this message translates to:
  /// **'Jupiter Storm'**
  String get locAstronautJupiterStorm;

  /// No description provided for @locAstronautIceMoon.
  ///
  /// In en, this message translates to:
  /// **'Ice Moon'**
  String get locAstronautIceMoon;

  /// No description provided for @locAstronautLunarBase.
  ///
  /// In en, this message translates to:
  /// **'Lunar Base'**
  String get locAstronautLunarBase;

  /// No description provided for @goalAstronautPlantFlag.
  ///
  /// In en, this message translates to:
  /// **'Plant a Flag'**
  String get goalAstronautPlantFlag;

  /// No description provided for @goalAstronautFirstContact.
  ///
  /// In en, this message translates to:
  /// **'First Contact'**
  String get goalAstronautFirstContact;

  /// No description provided for @goalAstronautStardustSample.
  ///
  /// In en, this message translates to:
  /// **'Collect Stardust'**
  String get goalAstronautStardustSample;

  /// No description provided for @goalAstronautSpaceGarden.
  ///
  /// In en, this message translates to:
  /// **'Grow a Space Garden'**
  String get goalAstronautSpaceGarden;

  /// No description provided for @locPirateVolcanicAtoll.
  ///
  /// In en, this message translates to:
  /// **'Volcanic Atoll'**
  String get locPirateVolcanicAtoll;

  /// No description provided for @locPirateMermaidLagoon.
  ///
  /// In en, this message translates to:
  /// **'Mermaid Lagoon'**
  String get locPirateMermaidLagoon;

  /// No description provided for @locPirateKrakenWaters.
  ///
  /// In en, this message translates to:
  /// **'Kraken Waters'**
  String get locPirateKrakenWaters;

  /// No description provided for @locPirateGhostShip.
  ///
  /// In en, this message translates to:
  /// **'Ghost Ship'**
  String get locPirateGhostShip;

  /// No description provided for @goalPirateTameKraken.
  ///
  /// In en, this message translates to:
  /// **'Tame the Kraken'**
  String get goalPirateTameKraken;

  /// No description provided for @goalPirateMutinyCalm.
  ///
  /// In en, this message translates to:
  /// **'Calm a Mutiny'**
  String get goalPirateMutinyCalm;

  /// No description provided for @goalPirateRescueParrot.
  ///
  /// In en, this message translates to:
  /// **'Rescue the Parrot'**
  String get goalPirateRescueParrot;

  /// No description provided for @goalPirateFreeGhostCrew.
  ///
  /// In en, this message translates to:
  /// **'Free the Ghost Crew'**
  String get goalPirateFreeGhostCrew;

  /// No description provided for @locWizardStarlitGlade.
  ///
  /// In en, this message translates to:
  /// **'Starlit Glade'**
  String get locWizardStarlitGlade;

  /// No description provided for @locWizardPhoenixNest.
  ///
  /// In en, this message translates to:
  /// **'Phoenix Nest'**
  String get locWizardPhoenixNest;

  /// No description provided for @locWizardMoonCourt.
  ///
  /// In en, this message translates to:
  /// **'Moon Court'**
  String get locWizardMoonCourt;

  /// No description provided for @locWizardFaeMarket.
  ///
  /// In en, this message translates to:
  /// **'Fae Market'**
  String get locWizardFaeMarket;

  /// No description provided for @goalWizardFirstSpell.
  ///
  /// In en, this message translates to:
  /// **'Cast Your First Spell'**
  String get goalWizardFirstSpell;

  /// No description provided for @goalWizardRestorePhoenix.
  ///
  /// In en, this message translates to:
  /// **'Restore the Phoenix'**
  String get goalWizardRestorePhoenix;

  /// No description provided for @goalWizardMoonBlessing.
  ///
  /// In en, this message translates to:
  /// **'Earn the Moon\'s Blessing'**
  String get goalWizardMoonBlessing;

  /// No description provided for @goalWizardFaeBargain.
  ///
  /// In en, this message translates to:
  /// **'Strike a Fae Bargain'**
  String get goalWizardFaeBargain;

  /// No description provided for @locPrincessRoseMaze.
  ///
  /// In en, this message translates to:
  /// **'Rose Maze'**
  String get locPrincessRoseMaze;

  /// No description provided for @locPrincessCrystalTower.
  ///
  /// In en, this message translates to:
  /// **'Crystal Tower'**
  String get locPrincessCrystalTower;

  /// No description provided for @locPrincessDawnGardens.
  ///
  /// In en, this message translates to:
  /// **'Dawn Gardens'**
  String get locPrincessDawnGardens;

  /// No description provided for @locPrincessTeaPavilion.
  ///
  /// In en, this message translates to:
  /// **'Tea Pavilion'**
  String get locPrincessTeaPavilion;

  /// No description provided for @goalPrincessTeaWithDragon.
  ///
  /// In en, this message translates to:
  /// **'Tea with a Dragon'**
  String get goalPrincessTeaWithDragon;

  /// No description provided for @goalPrincessFairyPact.
  ///
  /// In en, this message translates to:
  /// **'Make a Fairy Pact'**
  String get goalPrincessFairyPact;

  /// No description provided for @goalPrincessSingingRose.
  ///
  /// In en, this message translates to:
  /// **'Wake the Singing Rose'**
  String get goalPrincessSingingRose;

  /// No description provided for @goalPrincessLostKitten.
  ///
  /// In en, this message translates to:
  /// **'Find the Lost Kitten'**
  String get goalPrincessLostKitten;

  /// No description provided for @locKnightSilverLake.
  ///
  /// In en, this message translates to:
  /// **'Silver Lake'**
  String get locKnightSilverLake;

  /// No description provided for @locKnightTournamentField.
  ///
  /// In en, this message translates to:
  /// **'Tournament Field'**
  String get locKnightTournamentField;

  /// No description provided for @locKnightWizardGrove.
  ///
  /// In en, this message translates to:
  /// **'Wizard\'s Grove'**
  String get locKnightWizardGrove;

  /// No description provided for @locKnightHauntedKeep.
  ///
  /// In en, this message translates to:
  /// **'Haunted Keep'**
  String get locKnightHauntedKeep;

  /// No description provided for @goalKnightTameGriffin.
  ///
  /// In en, this message translates to:
  /// **'Tame a Griffin'**
  String get goalKnightTameGriffin;

  /// No description provided for @goalKnightCrossBridge.
  ///
  /// In en, this message translates to:
  /// **'Cross the Enchanted Bridge'**
  String get goalKnightCrossBridge;

  /// No description provided for @goalKnightFirstQuest.
  ///
  /// In en, this message translates to:
  /// **'First Quest'**
  String get goalKnightFirstQuest;

  /// No description provided for @goalKnightSootheGhost.
  ///
  /// In en, this message translates to:
  /// **'Soothe a Lonely Ghost'**
  String get goalKnightSootheGhost;

  /// No description provided for @locMermaidKelpForest.
  ///
  /// In en, this message translates to:
  /// **'Kelp Forest'**
  String get locMermaidKelpForest;

  /// No description provided for @locMermaidMoonlightBay.
  ///
  /// In en, this message translates to:
  /// **'Moonlight Bay'**
  String get locMermaidMoonlightBay;

  /// No description provided for @locMermaidJellyfishGlade.
  ///
  /// In en, this message translates to:
  /// **'Jellyfish Glade'**
  String get locMermaidJellyfishGlade;

  /// No description provided for @locMermaidShipwreckGarden.
  ///
  /// In en, this message translates to:
  /// **'Shipwreck Garden'**
  String get locMermaidShipwreckGarden;

  /// No description provided for @goalMermaidBabyOctopus.
  ///
  /// In en, this message translates to:
  /// **'Help a Baby Octopus'**
  String get goalMermaidBabyOctopus;

  /// No description provided for @goalMermaidLostStarfish.
  ///
  /// In en, this message translates to:
  /// **'Guide a Lost Starfish'**
  String get goalMermaidLostStarfish;

  /// No description provided for @goalMermaidTidePoolFriend.
  ///
  /// In en, this message translates to:
  /// **'Make a Tide-Pool Friend'**
  String get goalMermaidTidePoolFriend;

  /// No description provided for @goalMermaidLearnSong.
  ///
  /// In en, this message translates to:
  /// **'Learn the Mermaid Song'**
  String get goalMermaidLearnSong;

  /// No description provided for @locSuperheroSubwayTunnels.
  ///
  /// In en, this message translates to:
  /// **'Subway Tunnels'**
  String get locSuperheroSubwayTunnels;

  /// No description provided for @locSuperheroSkyArena.
  ///
  /// In en, this message translates to:
  /// **'Sky Arena'**
  String get locSuperheroSkyArena;

  /// No description provided for @locSuperheroFrozenCity.
  ///
  /// In en, this message translates to:
  /// **'Frozen Metropolis'**
  String get locSuperheroFrozenCity;

  /// No description provided for @locSuperheroParallelWorld.
  ///
  /// In en, this message translates to:
  /// **'Parallel World'**
  String get locSuperheroParallelWorld;

  /// No description provided for @goalSuperheroFirstSave.
  ///
  /// In en, this message translates to:
  /// **'Your First Rescue'**
  String get goalSuperheroFirstSave;

  /// No description provided for @goalSuperheroTeamUp.
  ///
  /// In en, this message translates to:
  /// **'Team Up With a Hero'**
  String get goalSuperheroTeamUp;

  /// No description provided for @goalSuperheroReverseFreeze.
  ///
  /// In en, this message translates to:
  /// **'Thaw the City'**
  String get goalSuperheroReverseFreeze;

  /// No description provided for @goalSuperheroFindMentor.
  ///
  /// In en, this message translates to:
  /// **'Find a Mentor'**
  String get goalSuperheroFindMentor;

  /// No description provided for @locChefSpiceCaravan.
  ///
  /// In en, this message translates to:
  /// **'Spice Caravan'**
  String get locChefSpiceCaravan;

  /// No description provided for @locChefCloudPantry.
  ///
  /// In en, this message translates to:
  /// **'Cloud Pantry'**
  String get locChefCloudPantry;

  /// No description provided for @locChefRainbowOrchard.
  ///
  /// In en, this message translates to:
  /// **'Rainbow Orchard'**
  String get locChefRainbowOrchard;

  /// No description provided for @locChefUnderwaterGalley.
  ///
  /// In en, this message translates to:
  /// **'Underwater Galley'**
  String get locChefUnderwaterGalley;

  /// No description provided for @goalChefRainbowPie.
  ///
  /// In en, this message translates to:
  /// **'Bake a Rainbow Pie'**
  String get goalChefRainbowPie;

  /// No description provided for @goalChefMidnightFeast.
  ///
  /// In en, this message translates to:
  /// **'Midnight Feast'**
  String get goalChefMidnightFeast;

  /// No description provided for @goalChefSpiceQuest.
  ///
  /// In en, this message translates to:
  /// **'Find a Magic Spice'**
  String get goalChefSpiceQuest;

  /// No description provided for @goalChefFirstDish.
  ///
  /// In en, this message translates to:
  /// **'Your First Dish'**
  String get goalChefFirstDish;

  /// No description provided for @locScientistMushroomLab.
  ///
  /// In en, this message translates to:
  /// **'Mushroom Lab'**
  String get locScientistMushroomLab;

  /// No description provided for @locScientistParticleChamber.
  ///
  /// In en, this message translates to:
  /// **'Particle Chamber'**
  String get locScientistParticleChamber;

  /// No description provided for @locScientistDesertDig.
  ///
  /// In en, this message translates to:
  /// **'Desert Dig Site'**
  String get locScientistDesertDig;

  /// No description provided for @locScientistRainforestCanopy.
  ///
  /// In en, this message translates to:
  /// **'Rainforest Canopy'**
  String get locScientistRainforestCanopy;

  /// No description provided for @goalScientistFirstInvention.
  ///
  /// In en, this message translates to:
  /// **'Your First Invention'**
  String get goalScientistFirstInvention;

  /// No description provided for @goalScientistGlowingPlant.
  ///
  /// In en, this message translates to:
  /// **'Grow a Glowing Plant'**
  String get goalScientistGlowingPlant;

  /// No description provided for @goalScientistParticlePuzzle.
  ///
  /// In en, this message translates to:
  /// **'Solve a Particle Puzzle'**
  String get goalScientistParticlePuzzle;

  /// No description provided for @goalScientistAnimalLanguage.
  ///
  /// In en, this message translates to:
  /// **'Decode Animal Language'**
  String get goalScientistAnimalLanguage;

  /// No description provided for @locNinjaCherryGrove.
  ///
  /// In en, this message translates to:
  /// **'Cherry Grove'**
  String get locNinjaCherryGrove;

  /// No description provided for @locNinjaKoiPond.
  ///
  /// In en, this message translates to:
  /// **'Koi Pond'**
  String get locNinjaKoiPond;

  /// No description provided for @locNinjaIronDojo.
  ///
  /// In en, this message translates to:
  /// **'Iron Dojo'**
  String get locNinjaIronDojo;

  /// No description provided for @locNinjaLanternPass.
  ///
  /// In en, this message translates to:
  /// **'Lantern Pass'**
  String get locNinjaLanternPass;

  /// No description provided for @goalNinjaSilentPassage.
  ///
  /// In en, this message translates to:
  /// **'Pass in Silence'**
  String get goalNinjaSilentPassage;

  /// No description provided for @goalNinjaFirstTest.
  ///
  /// In en, this message translates to:
  /// **'Your First Test'**
  String get goalNinjaFirstTest;

  /// No description provided for @goalNinjaTameTiger.
  ///
  /// In en, this message translates to:
  /// **'Befriend the Tiger'**
  String get goalNinjaTameTiger;

  /// No description provided for @goalNinjaRestoreBalance.
  ///
  /// In en, this message translates to:
  /// **'Restore the Balance'**
  String get goalNinjaRestoreBalance;

  /// No description provided for @locExplorerCloudForest.
  ///
  /// In en, this message translates to:
  /// **'Cloud Forest'**
  String get locExplorerCloudForest;

  /// No description provided for @locExplorerSaltFlats.
  ///
  /// In en, this message translates to:
  /// **'Salt Flats'**
  String get locExplorerSaltFlats;

  /// No description provided for @locExplorerGlowwormCave.
  ///
  /// In en, this message translates to:
  /// **'Glowworm Cave'**
  String get locExplorerGlowwormCave;

  /// No description provided for @locExplorerSkyCanyon.
  ///
  /// In en, this message translates to:
  /// **'Sky Canyon'**
  String get locExplorerSkyCanyon;

  /// No description provided for @goalExplorerFirstDiscovery.
  ///
  /// In en, this message translates to:
  /// **'Your First Discovery'**
  String get goalExplorerFirstDiscovery;

  /// No description provided for @goalExplorerStarMap.
  ///
  /// In en, this message translates to:
  /// **'Follow the Star Map'**
  String get goalExplorerStarMap;

  /// No description provided for @goalExplorerRescueCompanion.
  ///
  /// In en, this message translates to:
  /// **'Rescue a Companion'**
  String get goalExplorerRescueCompanion;

  /// No description provided for @goalExplorerAncientClue.
  ///
  /// In en, this message translates to:
  /// **'Decipher an Ancient Clue'**
  String get goalExplorerAncientClue;

  /// No description provided for @locVetButterflyMeadow.
  ///
  /// In en, this message translates to:
  /// **'Butterfly Meadow'**
  String get locVetButterflyMeadow;

  /// No description provided for @locVetSnowyPinewood.
  ///
  /// In en, this message translates to:
  /// **'Snowy Pinewood'**
  String get locVetSnowyPinewood;

  /// No description provided for @locVetFireflySwamp.
  ///
  /// In en, this message translates to:
  /// **'Firefly Swamp'**
  String get locVetFireflySwamp;

  /// No description provided for @locVetRescueClinic.
  ///
  /// In en, this message translates to:
  /// **'Rescue Clinic'**
  String get locVetRescueClinic;

  /// No description provided for @goalVetButterflyWing.
  ///
  /// In en, this message translates to:
  /// **'Mend a Butterfly Wing'**
  String get goalVetButterflyWing;

  /// No description provided for @goalVetLostPuppy.
  ///
  /// In en, this message translates to:
  /// **'Find the Lost Puppy'**
  String get goalVetLostPuppy;

  /// No description provided for @goalVetShyUnicorn.
  ///
  /// In en, this message translates to:
  /// **'Coax a Shy Unicorn'**
  String get goalVetShyUnicorn;

  /// No description provided for @goalVetSleepingBear.
  ///
  /// In en, this message translates to:
  /// **'Wake a Sleeping Bear Cub'**
  String get goalVetSleepingBear;

  /// No description provided for @locInventorTinkerMarket.
  ///
  /// In en, this message translates to:
  /// **'Tinker Market'**
  String get locInventorTinkerMarket;

  /// No description provided for @locInventorGearGarden.
  ///
  /// In en, this message translates to:
  /// **'Gear Garden'**
  String get locInventorGearGarden;

  /// No description provided for @locInventorLightningLab.
  ///
  /// In en, this message translates to:
  /// **'Lightning Lab'**
  String get locInventorLightningLab;

  /// No description provided for @locInventorPaperWorkshop.
  ///
  /// In en, this message translates to:
  /// **'Paper Workshop'**
  String get locInventorPaperWorkshop;

  /// No description provided for @goalInventorFirstInvention.
  ///
  /// In en, this message translates to:
  /// **'Your First Invention'**
  String get goalInventorFirstInvention;

  /// No description provided for @goalInventorFixClockTower.
  ///
  /// In en, this message translates to:
  /// **'Fix the Clock Tower'**
  String get goalInventorFixClockTower;

  /// No description provided for @goalInventorPaperCreature.
  ///
  /// In en, this message translates to:
  /// **'Build a Paper Creature'**
  String get goalInventorPaperCreature;

  /// No description provided for @goalInventorKiteStorm.
  ///
  /// In en, this message translates to:
  /// **'Tame the Kite Storm'**
  String get goalInventorKiteStorm;

  /// No description provided for @locDinoHunterTarPit.
  ///
  /// In en, this message translates to:
  /// **'Tar Pit'**
  String get locDinoHunterTarPit;

  /// No description provided for @locDinoHunterFrozenTundra.
  ///
  /// In en, this message translates to:
  /// **'Frozen Tundra'**
  String get locDinoHunterFrozenTundra;

  /// No description provided for @locDinoHunterMuseumArchive.
  ///
  /// In en, this message translates to:
  /// **'Museum Archive'**
  String get locDinoHunterMuseumArchive;

  /// No description provided for @locDinoHunterShallowLagoon.
  ///
  /// In en, this message translates to:
  /// **'Shallow Lagoon'**
  String get locDinoHunterShallowLagoon;

  /// No description provided for @goalDinoHunterFirstFossil.
  ///
  /// In en, this message translates to:
  /// **'Your First Fossil'**
  String get goalDinoHunterFirstFossil;

  /// No description provided for @goalDinoHunterMammothFriend.
  ///
  /// In en, this message translates to:
  /// **'Befriend a Mammoth Calf'**
  String get goalDinoHunterMammothFriend;

  /// No description provided for @goalDinoHunterPterodactyl.
  ///
  /// In en, this message translates to:
  /// **'Sky Ride With a Pterodactyl'**
  String get goalDinoHunterPterodactyl;

  /// No description provided for @goalDinoHunterLostSkeleton.
  ///
  /// In en, this message translates to:
  /// **'Reassemble a Lost Skeleton'**
  String get goalDinoHunterLostSkeleton;

  /// No description provided for @locFirefighterRooftopDistrict.
  ///
  /// In en, this message translates to:
  /// **'Rooftop District'**
  String get locFirefighterRooftopDistrict;

  /// No description provided for @locFirefighterTunnelNetwork.
  ///
  /// In en, this message translates to:
  /// **'Tunnel Network'**
  String get locFirefighterTunnelNetwork;

  /// No description provided for @locFirefighterCircusTent.
  ///
  /// In en, this message translates to:
  /// **'Circus Tent'**
  String get locFirefighterCircusTent;

  /// No description provided for @locFirefighterLighthouse.
  ///
  /// In en, this message translates to:
  /// **'Lighthouse Cliff'**
  String get locFirefighterLighthouse;

  /// No description provided for @goalFirefighterFirstCall.
  ///
  /// In en, this message translates to:
  /// **'Your First Call'**
  String get goalFirefighterFirstCall;

  /// No description provided for @goalFirefighterRescueKitten.
  ///
  /// In en, this message translates to:
  /// **'Rescue a Kitten'**
  String get goalFirefighterRescueKitten;

  /// No description provided for @goalFirefighterCalmCircus.
  ///
  /// In en, this message translates to:
  /// **'Calm the Circus'**
  String get goalFirefighterCalmCircus;

  /// No description provided for @goalFirefighterStormLighthouse.
  ///
  /// In en, this message translates to:
  /// **'Save the Lighthouse'**
  String get goalFirefighterStormLighthouse;

  /// No description provided for @locRobotPilotScrapYard.
  ///
  /// In en, this message translates to:
  /// **'Scrap Yard'**
  String get locRobotPilotScrapYard;

  /// No description provided for @locRobotPilotQuantumArena.
  ///
  /// In en, this message translates to:
  /// **'Quantum Arena'**
  String get locRobotPilotQuantumArena;

  /// No description provided for @locRobotPilotDataCanyon.
  ///
  /// In en, this message translates to:
  /// **'Data Canyon'**
  String get locRobotPilotDataCanyon;

  /// No description provided for @locRobotPilotOrbitalGarden.
  ///
  /// In en, this message translates to:
  /// **'Orbital Garden'**
  String get locRobotPilotOrbitalGarden;

  /// No description provided for @goalRobotPilotFirstFlight.
  ///
  /// In en, this message translates to:
  /// **'Your First Flight'**
  String get goalRobotPilotFirstFlight;

  /// No description provided for @goalRobotPilotRebuildFriend.
  ///
  /// In en, this message translates to:
  /// **'Rebuild a Robot Friend'**
  String get goalRobotPilotRebuildFriend;

  /// No description provided for @goalRobotPilotDataMystery.
  ///
  /// In en, this message translates to:
  /// **'Solve a Data Mystery'**
  String get goalRobotPilotDataMystery;

  /// No description provided for @goalRobotPilotTendGarden.
  ///
  /// In en, this message translates to:
  /// **'Tend the Orbital Garden'**
  String get goalRobotPilotTendGarden;
  ...
  /// No description provided for @readerFinish.
  ///
  /// In en, this message translates to:
  /// **'Finish'**
  String get readerFinish;

  /// No description provided for @readerAgain.
  ///
  /// In en, this message translates to:
  /// **'Again'**
  String get readerAgain;
